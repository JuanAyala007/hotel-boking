 ...
 useEffect(() => {
  ...
  return (
    <div>
      ...
      <h2 className='hotel-rating'> Rating - <span className='hotel-rating-value'>{hotel?.rating}</span> </h2>
      ...
      <div className='hotel-map'>
          {
            hotel &&
            <Map height={280} defaultCenter={[+hotel?.lat, +hotel?.lon]} defaultZoomZoom={8}  maxZoom={20}>
              <Overlay anchor={[+hotel?.lat, +hotel?.lon]} color='red' offset={[20, 20]}>
